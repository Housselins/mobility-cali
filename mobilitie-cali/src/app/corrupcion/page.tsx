...
const Corrupcion = () => {
  ...
  const handleSubmit = async () => {
    ...
    if (
      ...
      !denunciante.apellidoDenunciante ||
      !denunciante.numeroIdentificacion ||
      !denuncia.nombresApellidos ||
      !denuncia.camposRol ||
      !denuncia.organismo
    ) {
      setErrors({
    ...
    <>
      <ThemeProvider theme={theme}>
        <div className="contenedor-principal-corrupcion">
          ...
          <div className="center-container overflow-y-auto">
            <Select
              value={mode}
              onChange={(event) =>
            ...
            <div className="card bg-base-100 custom-card-width shadow-xl border">
              <figure className="bg-white">
                <img
                  className="image-alcaldia"
              ...
              <div className="card-body">
                {mostrarFormulario ? (
                  <>
                    <span className="card-title-corrupcion">
                      BIENVENIDO(A) AL CANAL DE DENUNCIA VIRTUAL POR PRESUNTOS
                      HECHOS DE CORRUPCIÓN Leer con atención antes de interponer
                      la denuncia
                    </span>
                    <p>
                      1. Verificar si es un acto de corrupción lo que desea
                      denunciar.
                      <br />
                      2. Presente una relación clara, detallada y precisa de los
                      hechos de los cuales tiene conocimiento.
                      <br />
                      3. Tener las pruebas suficientes: DOCUMENTACIÓN, FOTOS,
                ...
                <p
                  className="formato-paso-a-paso"
                  onClick={mostrarFormularioDenuncia}
                >
                  <div className="contenedor-icon-formato-paso">
                    <FaFileAlt className="icon-formato-paso" />
                    {mostrarFormulario
                      ? "Cerrar formato"
                      : "Abrir formato para ser diligenciado"}
                  </div>
                </p>
                ...
                <p className="formato-paso-a-paso">
                  <div className="contenedor-icon-formato-paso">
                    ...
                    <a
                      href="https://www.youtube.com/watch?v=4rl9nIfLdU8"
                      target="_blank"
                ...
                <div className=" bg-white custom-card-width ">
                  <Accordion>
                    ...
                    <AccordionDetails>
                      <form>
                        ...
                        <div className="bg-transparent flex flex-row gap-2 mb-2 mt-2">
                          <input
                            id="anonimidad"
                            type="checkbox"
                            className="checkbox "
                  ...
                  <Accordion>
                    ...
                    <AccordionDetails>
                          ...
                          <div className="form-control">
                            <label className="label">
                              <span className="message-accordion">
                                DATOS DEL SERVIDOR PÚBLICO O CONTRATISTA
                                INVOLUCRADO EN EL PRESUNTO HECHO DE CORRUPCIÓN
                              </span>
                            </label>
                          </div>
                        </div>
                      ...
                      <form>
                        {errors.denuncia && (
                          <div className="error-message">{errors.denuncia}</div>
                        )}
                      ...
                      <div className="card bg-base-100  shadow-xl">
                        <div className="card-body-corrupcion">
                          <div className="form-control">
                            <label className="label">
                              <span className="message-accordion">
                                ANEXA AQUÍ LA EVIDENCIA QUE SOPORTE TU DENUNCIA
                                (documentos, imágenes, videos, audios, etc.).
                                RECUERDA QUE ESTA ES CLAVE PARA EL PROCESO
                              </span>
                            </label>
                          </div>
                        </div>
                        ...
                        <div className="card bg-base-100  shadow-xl">
                          <div className="card-body-corrupcion">
                            <div className="form-control">
                              <label className="label">
                                <span className="message-accordion">
                                  EN EL CASO QUE CUENTES CON TESTIGOS DE LOS
                                  HECHOS DENUNCIADOS DILIGENCIA LOS SIGUIENTES
                                  DATOS.
                                </span>
                              </label>
                            </div>
                        ...
                        <div className="form-control">
                          <label className="label">
                            <span className="message-accordion">
                              ...
                              personales de los habitantes del municipio, estos
                              serán utilizados únicamente en el desarrollo de las
                              funciones propias y no se compartirán con nadie para
                              fines diferentes. Esta información es y será
                              utilizada para conocer más al ciudadano que se
                  ...
                  <div>
                    <button
                      type="submit"
                      className="btn-corrupcion btn btn-block btn-lg mt-3"
